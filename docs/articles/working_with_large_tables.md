...
#> $ REF_DATE                <string> "1978-05", "1978-05", "1978-05", "1978-05", "…
...
#> $ Sales                   <string> "Units", "Units", "Dollars", "Units", "Units"…
#> $ `Seasonal adjustment`   <string> "Unadjusted", "Seasonally adjusted", "Unadjus…
#> $ UOM                     <string> "Units", "Units", "Dollars", "Units", "Units"…
#> $ UOM_ID                  <string> "300", "300", "81", "300", "300", "81", "300"…
#> $ SCALAR_FACTOR           <string> "units", "units", "thousands", "units", "thou…
#> $ SCALAR_ID               <string> "0", "0", "3", "0", "3", "3", "0", "3", "3", …
#> $ VECTOR                  <string> "v42169920", "v42169921", "v42169922", "v4216…
#> $ COORDINATE              <string> "1.2.1.1.1", "1.2.1.1.2", "1.2.1.2.1", "1.2.2…
#> $ VALUE                   <double> 109738, 85845, 695431, 90106, 70455, 587062, …
#> $ STATUS                  <string> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, N…
#> $ SYMBOL                  <string> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, N…
#> $ TERMINATED              <string> NA, "t", NA, NA, "t", NA, NA, "t", NA, NA, NA…
...
#> New motor vehicle sales, inactive
#> CANSIM Table 20-10-0001
#> Start Reference Period: 1946-01-01, End Reference Period: 2024-12-01, Frequency: Monthly
#> 
#> Column Geography (11)
...
#>   REF_DATE Date       GEO    DGUID  GeoUID `Vehicle type` Origin of manufactur…¹
#>   <chr>    <date>     <fct>  <chr>  <chr>  <fct>          <fct>                 
#> 1 1973-05  1973-05-01 Canada 2016A… 11124  Passenger cars Total, country of man…
#> 2 1973-05  1973-05-01 Canada 2016A… 11124  Trucks         Total, country of man…
#> 3 1973-06  1973-06-01 Canada 2016A… 11124  Passenger cars Total, country of man…
#> 4 1973-06  1973-06-01 Canada 2016A… 11124  Trucks         Total, country of man…
#> 5 1973-07  1973-07-01 Canada 2016A… 11124  Passenger cars Total, country of man…
#> 6 1973-07  1973-07-01 Canada 2016A… 11124  Trucks         Total, country of man…
#> # ℹ abbreviated name: ¹​`Origin of manufacture`
#> # ℹ 23 more variables: Sales <fct>, `Seasonal adjustment` <fct>, VALUE <dbl>,
#> #   val_norm <dbl>, UOM <chr>, UOM_ID <chr>, SCALAR_FACTOR <chr>,
#> #   SCALAR_ID <chr>, VECTOR <chr>, COORDINATE <chr>, STATUS <chr>,
...
#>  6 13-10-0920        eng      parquet    2026-08-18 07:58:30 0.4.5        
#>  7 13-10-0920        eng      sqlite     2026-08-18 07:58:28 0.4.5        
