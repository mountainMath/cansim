...
head(data)
#> # A tibble: 6 x 21
#>   REF_DATE GEO   DGUID `Labour force c~ Statistics UOM   UOM_ID SCALAR_FACTOR SCALAR_ID VECTOR COORDINATE   VALUE STATUS SYMBOL TERMINATED DECIMALS GeoUID
#>   <chr>    <chr> <chr> <chr>            <chr>      <chr> <chr>  <chr>         <chr>     <chr>  <chr>        <dbl> <chr>  <chr>  <chr>      <chr>    <chr> 
#> 1 2001-03  Cana~ 2016~ Population       Estimate   Pers~ 249    thousands     3         v9141~ 1.1.1      24281.  <NA>   <NA>   <NA>       1        11124 
#> 2 2001-03  Cana~ 2016~ Labour force     Estimate   Pers~ 249    thousands     3         v9141~ 1.2.1      15758.  <NA>   <NA>   <NA>       1        11124 
#> 3 2001-03  Cana~ 2016~ Labour force     Standard ~ Pers~ 249    thousands     3         v1018~ 1.2.2         33   <NA>   <NA>   <NA>       1        11124 
#> 4 2001-03  Cana~ 2016~ Labour force     Standard ~ Pers~ 249    thousands     3         v1018~ 1.2.3         NA   ..     <NA>   <NA>       1        11124 
#> 5 2001-03  Cana~ 2016~ Employment       Estimate   Pers~ 249    thousands     3         v9141~ 1.3.1      14572.  <NA>   <NA>   <NA>       1        11124 
#> 6 2001-03  Cana~ 2016~ Employment       Standard ~ Pers~ 249    thousands     3         v1018~ 1.3.2         36.3 <NA>   <NA>   <NA>       1        11124 
#> # ... with 4 more variables: `Classification Code for Labour force characteristics` <chr>, `Hierarchy for Labour force characteristics` <chr>, `Classification Code
#> #   for Statistics` <chr>, `Hierarchy for Statistics` <chr>
```
...
head(data)
#> # A tibble: 6 x 20
#>   REF_DATE GEO   DGUID `Labour force c~ Statistics UOM   UOM_ID VECTOR COORDINATE   VALUE STATUS SYMBOL TERMINATED DECIMALS GeoUID `Classification~ `Hierarchy for ~
#>   <chr>    <chr> <chr> <chr>            <chr>      <chr> <chr>  <chr>  <chr>        <dbl> <chr>  <chr>  <chr>      <chr>    <chr>  <chr>            <chr>           
#> 1 2001-03  Cana~ 2016~ Population       Estimate   Pers~ 249    v9141~ 1.1.1       2.43e7 <NA>   <NA>   <NA>       1        11124  <NA>             1               
#> 2 2001-03  Cana~ 2016~ Labour force     Estimate   Pers~ 249    v9141~ 1.2.1       1.58e7 <NA>   <NA>   <NA>       1        11124  <NA>             1.2             
#> 3 2001-03  Cana~ 2016~ Labour force     Standard ~ Pers~ 249    v1018~ 1.2.2       3.30e4 <NA>   <NA>   <NA>       1        11124  <NA>             1.2             
#> 4 2001-03  Cana~ 2016~ Labour force     Standard ~ Pers~ 249    v1018~ 1.2.3      NA      ..     <NA>   <NA>       1        11124  <NA>             1.2             
#> 5 2001-03  Cana~ 2016~ Employment       Estimate   Pers~ 249    v9141~ 1.3.1       1.46e7 <NA>   <NA>   <NA>       1        11124  <NA>             1.2.3           
#> 6 2001-03  Cana~ 2016~ Employment       Standard ~ Pers~ 249    v1018~ 1.3.2       3.63e4 <NA>   <NA>   <NA>       1        11124  <NA>             1.2.3           
#> # ... with 3 more variables: `Classification Code for Statistics` <chr>, `Hierarchy for Statistics` <chr>, Date <date>
```
...
#> Start Reference Period: 2001-03-01, End Reference Period: 2020-02-01, Frequency: Monthly
#> 
#> Column Geography (76)
...
#> # A tibble: 11 x 21
#>    title title_en title_fr keywords_en keywords keywords_fr notes notes_en notes_fr state subject date_published frequency revision_id time_period_cov~
#>    <chr> <chr>    <chr>    <chr>       <chr>    <chr>       <chr> <chr>    <chr>    <chr> <chr>   <chr>          <chr>     <chr>       <chr>           
#>  1 Resi~ Residen~ Indice ~ housing, h~ housing~ housing, h~ <p>R~ <p>Resi~ <p>Indi~ acti~ econom~ 2020-01-29 08~ P3M       1afb8a35-7~ 2017-01-01 00:0~
#>  2 New ~ New hou~ Indice ~ constructi~ constru~ constructi~ <p>N~ <p>New ~ <p>Indi~ acti~ econom~ 2020-02-20 08~ P1Y       bcf699b7-4~ 2017-01-01 00:0~
#>  3 Buil~ Buildin~ Indices~ housing, h~ housing~ housing, h~ <p>B~ <p>Buil~ <p>Indi~ acti~ econom~ 2020-02-06 08~ P3M       f309593c-0~ 1981-01-01 00:0~
#>  4 New ~ New hou~ Indice ~ constructi~ constru~ constructi~ <p>N~ <p>New ~ <p>Indi~ acti~ econom~ 2020-02-20 08~ P1M       ee45fd0b-0~ 1981-01-01 00:0~
#>  5 Resi~ Residen~ Indice ~ housing, h~ housing~ housing, h~ <p>R~ <p>Resi~ <p>Les ~ acti~ econom~ 2019-11-14 08~ P1Y       d6a7c8d3-5~ 2017-01-01 00:0~
#>  6 Pric~ Price i~ Indices~ housing, h~ housing~ housing, h~ <p>T~ <p>This~ Ce tabl~ acti~ econom~ 2017-02-27 08~ P3M       b8454b05-c~ 1986-01-01 00:0~
#>  7 New ~ New hou~ Indices~ constructi~ constru~ constructi~ This~ This ta~ Ce tabl~ acti~ econom~ 2017-02-27 08~ P1M       6c21294a-9~ 1981-01-01 00:0~
#>  8 New ~ New hou~ Indices~ constructi~ constru~ constructi~ This~ This ta~ Ce tabl~ acti~ econom~ 2017-02-27 08~ P1M       35fc176d-3~ 1981-01-01 00:0~
#>  9 Pric~ Price i~ Indices~ housing, h~ housing~ housing, h~ This~ This ta~ Ce tabl~ acti~ econom~ 2017-02-27 08~ P3M       f7abbbfd-0~ 1981-01-01 00:0~
#> 10 Non-~ Non-res~ Indice ~ constructi~ constru~ constructi~ <p>A~ <p>Arch~ <p>Arch~ acti~ econom~ 2018-05-23 08~ P3M       592129f5-2~ 1981-01-01 00:0~
#> 11 New ~ New hou~ Indice ~ constructi~ constru~ constructi~ Mont~ Monthly~ Indice ~ acti~ econom~ 2017-03-09 08~ P1Y       38bfc609-7~ 2007-01-01 00:0~
#> # ... with 6 more variables: time_period_coverage_end <chr>, metadata_created <chr>, metadata_modified <chr>, url_en <chr>, url_fr <chr>, cansim_table_number <chr>
```
...
#> 1        1  122. 2015-05-01 2018-06-12T08:30      0             6         0 27.2.0.0.0.0.0.0.0.0 v41692930 Metro Van CPI                               
#> 2        1  122. 2015-06-01 2018-06-12T08:30      0             6         0 27.2.0.0.0.0.0.0.0.0 v41692930 Metro Van CPI                               
#> 3        1  122. 2015-07-01 2018-06-12T08:30      0             6         0 27.2.0.0.0.0.0.0.0.0 v41692930 Metro Van CPI                               
#> 4        1  123. 2015-08-01 2018-06-12T08:30      0             6         0 27.2.0.0.0.0.0.0.0.0 v41692930 Metro Van CPI                               
#> 5        1  153  2015-07-01 2015-11-10T08:30      0             9         0 8.7.1.0.0.0.0.0.0.0  v44176267 Metro Van Apartment Construction Price Index
```
