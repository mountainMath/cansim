...
head(data)
#> # A tibble: 6 x 21
#>   REF_DATE GEO    DGUID   `Labour force ch… Statistics    UOM   UOM_ID SCALAR_FACTOR SCALAR_ID VECTOR COORDINATE
#>   <chr>    <chr>  <chr>   <chr>             <chr>         <chr> <chr>  <chr>         <chr>     <chr>  <chr>     
#> 1 2001-03  Canada 2016A0… Population        Estimate      Pers… 249    thousands     3         v9141… 1.1.1     
#> 2 2001-03  Canada 2016A0… Labour force      Estimate      Pers… 249    thousands     3         v9141… 1.2.1     
#> 3 2001-03  Canada 2016A0… Labour force      Standard err… Pers… 249    thousands     3         v1018… 1.2.2     
#> 4 2001-03  Canada 2016A0… Labour force      Standard err… Pers… 249    thousands     3         v1018… 1.2.3     
#> 5 2001-03  Canada 2016A0… Employment        Estimate      Pers… 249    thousands     3         v9141… 1.3.1     
#> 6 2001-03  Canada 2016A0… Employment        Standard err… Pers… 249    thousands     3         v1018… 1.3.2     
#> # … with 10 more variables: VALUE <dbl>, STATUS <chr>, SYMBOL <chr>, TERMINATED <chr>, DECIMALS <chr>,
#> #   GeoUID <chr>, Classification Code for Labour force characteristics <chr>,
#> #   Hierarchy for Labour force characteristics <chr>, Classification Code for Statistics <chr>,
#> #   Hierarchy for Statistics <chr>
```
...
head(data)
#> # A tibble: 6 x 20
#>   REF_DATE GEO    DGUID   `Labour force cha… Statistics     UOM   UOM_ID VECTOR COORDINATE   VALUE STATUS SYMBOL
#>   <chr>    <chr>  <chr>   <chr>              <chr>          <chr> <chr>  <chr>  <chr>        <dbl> <chr>  <chr> 
#> 1 2001-03  Canada 2016A0… Population         Estimate       Pers… 249    v9141… 1.1.1       2.43e7 <NA>   <NA>  
#> 2 2001-03  Canada 2016A0… Labour force       Estimate       Pers… 249    v9141… 1.2.1       1.58e7 <NA>   <NA>  
#> 3 2001-03  Canada 2016A0… Labour force       Standard erro… Pers… 249    v1018… 1.2.2       3.3 e4 <NA>   <NA>  
#> 4 2001-03  Canada 2016A0… Labour force       Standard erro… Pers… 249    v1018… 1.2.3      NA      ..     <NA>  
#> 5 2001-03  Canada 2016A0… Employment         Estimate       Pers… 249    v9141… 1.3.1       1.46e7 <NA>   <NA>  
#> 6 2001-03  Canada 2016A0… Employment         Standard erro… Pers… 249    v1018… 1.3.2       3.63e4 <NA>   <NA>  
#> # … with 8 more variables: TERMINATED <chr>, DECIMALS <chr>, GeoUID <chr>,
#> #   Classification Code for Labour force characteristics <chr>,
#> #   Hierarchy for Labour force characteristics <chr>, Classification Code for Statistics <chr>,
#> #   Hierarchy for Statistics <chr>, Date <date>
```
...
#>  1 New … New hou… Indice … constructi… constru… constructi… <p>N… <p>New … <p>Indi… acti… econom… 2021-03-18 08…
#>  2 New … New hou… Indice … constructi… constru… constructi… <p>N… <p>New … <p>Indi… acti… econom… 2021-02-18 08…
#>  3 Resi… Residen… Indice … housing, h… housing… housing, h… <p>R… <p>Resi… <p>Indi… acti… econom… 2021-02-08 08…
#>  4 Buil… Buildin… Indices… housing, h… housing… housing, h… <p>B… <p>Buil… <p>Indi… acti… econom… 2021-02-04 08…
#>  5 Resi… Residen… Indice … housing, h… housing… housing, h… <p>R… <p>Resi… <p>Les … acti… econom… 2020-07-30 08…
