...
```
In this vignette we show how to utilize the metadata information by drilling into NAICS categories and the hierarchy metadata that is downloaded with tables that have hierarchical data. 
