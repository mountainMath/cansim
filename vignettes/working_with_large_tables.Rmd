...
```{r}
get_cansim_column_list("20-10-0001")
```

Seeing the columns available we can inspect the available variables.

```{r}
get_cansim_column_categories("20-10-0001","Origin of manufacture")
```


```{r}
get_cansim_column_categories("20-10-0001","Seasonal adjustment")
```

```{r}
get_cansim_column_categories("20-10-0001","Sales")
```
