...
Partitioning happens on initial data import and stays fixed afterward, regardless of how partitioning is specified in subsequent calls. If data should be repartitioned it needs to be re-downloaded.
