...
#' @param search_description By default, this function will only search through table titles and setting this parameter to \code{TRUE} will instead search through table descriptions
